...
class VideoServiceTests {
    ...
    void update() {
        ...
        assertDoesNotThrow(() -> {
            service.update(100L, new VideoUpdateRequestDto("4321", "title 2", "contents 2"));
            VideoResponse video = service.find(100L);
    ...
    void update_invalid_youtube_id() {
        ...
        assertThrows(InvalidYoutubeIdException.class, () -> {
            service.update(100L, new VideoUpdateRequestDto("", "title2", "contents2"));
        });
    }
    ...
    void update_invalid_title() {
        ...
        assertThrows(InvalidTitleException.class, () -> {
            service.update(100L, new VideoUpdateRequestDto("1234", "", "contents2"));
        });
    }
    ...
    void update_invalid_contents() {
        ...
        assertThrows(InvalidContentsException.class, () -> {
            service.update(100L, new VideoUpdateRequestDto("1234", "title", ""));
        });
    }
}